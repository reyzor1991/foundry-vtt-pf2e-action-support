const battleSelfEffectMap = {
    ...
    'ki-rush': 'Compendium.pf2e-action-support.action-support.Item.CwBOiAsgZXA844HV',//?maybe general
    ...
    "dueling-parry-fighter": "Compendium.pf2e.feat-effects.Item.1nCwQErK6hpkNvfw",
    "dueling-parry-swashbuckler": "Compendium.pf2e.feat-effects.Item.1nCwQErK6hpkNvfw",
...
function battleMedicine(message) {
    if (game.combat && hasOption(message, "action:treat-wounds")
        && message.isRoll && message.rolls[0] instanceof CheckRoll) {
