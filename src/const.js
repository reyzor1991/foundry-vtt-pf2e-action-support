...
export const effect_blinded1_round = "Compendium.pf2e-action-support.action-support.Item.KmUCaFZSk9efn9AR";
export const effect_skunk_bomb_fail = "Compendium.pf2e-action-support.action-support.Item.Ed57eZ72j6RGAIp4";
export const effect_skunk_bomb_cfail = "Compendium.pf2e-action-support.action-support.Item.0v7THqjruKWI0wJ4";
...
export const effect_conduct_energy = "Compendium.pf2e.equipment-effects.Item.lU8IO9FIGK1DXVMy";
export const effect_daydream_trance = "Compendium.pf2e.feat-effects.Item.RATDyLyxXN3qmOas";
...
export const spellEffectMap = {
    ...
    'gravity-weapon': ['Compendium.pf2e.spell-effects.Item.tNjimcyUwn8afeH6'],
}
export const featEffectMap = {
